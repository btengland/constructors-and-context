...
/*
 Below we have the constructor Animal.  The eat method is using the "this" keyword.  Use the "new" keyword to assign context to "this", and save the instance to a variable named 
...
//Code Here
const animal1 = new Animal('Richard', 'Richardafant', 'chicken nuggets')
